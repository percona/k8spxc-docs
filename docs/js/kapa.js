(function () {
    ...
    function loadKapa() {
        ...
        script.setAttribute(
            ...
            "The **Percona AI Assistant** helps you find simple, clear answers to your Percona questions using [official documentation](https://docs.percona.com/), resolved [forum posts](https://forums.percona.com/) and [blog posts](https://www.percona.com/blog/). Note, do not enter personal or confidential information. Before using Percona AI assistant, read the [Legal Notice](https://docs.percona.com/percona-operator-for-xtradb-cluster/latest/legal-notice.html)."
        );

        script.setAttribute(
            "data-modal-example-questions",
            "How do I deploy Percona Operator for MySQL based on Percona XtraDB Cluster?, How do I connect my application to the Percona XtraDB Cluster?, How do I upgrade Percona Operator for MySQL?, How do I configure automated backups?"
        );

        script.setAttribute(
            "data-project-logo",
            "https://docs.percona.com/percona-operator-for-xtradb-cluster/latest/assets/percona-logomark-one-color-dark.png"
        );
