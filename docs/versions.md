...
|:--------|:--------|:-----|:-------|:-------|
|[1.19.0](ReleaseNotes/Kubernetes-Operator-for-PXC-RN1.19.0.md)  | 8.4 (Tech preview), 8.0, 5.7      | 8.4.0-5.1 for MySQL 8.4, 8.0.35-34.1 for MySQL 8.0, 2.4.29 for MySQL 5.7 | 2.8.17    | 2.7.3-1.2    |
